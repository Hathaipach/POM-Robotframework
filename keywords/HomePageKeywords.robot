...
*** Keywords ***
future skill should display home page and display message as "${expect_message}"
    CommonKeywords.Wait until page contains element then verify text  ${expect_message}
